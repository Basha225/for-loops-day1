    ...
    //  	for (let i = 1; i <= 5; i++) {
    //   for (let j = 1; j <= i; j++) {
    //     console.log(i, j);      // 1,1 2,1 2,2 3,1 3,2, 3,3 4,1 4,2 4,3 4,4 5,1 5,2 5,3 5,4 5,5
    //   }
    // }
    // –	
    // A)	15
    ...
    //  	for (let i = 2; i <= 4; i++) {
    //   for (let j = 1; j < i; j++) {
    //     console.log(i, j);   //2,1  3,1 3,2  4,1 4,2 4,3
    //   }
    // }
    // –	
    ...
    //  	for (let i = 0; i < 3; i++) {
    //   for (let j = i; j < 3; j++) {
    //     console.log(i, j);       //0,0 0,1 0,2  1,1 1,2  2,2 
    //   }
    // }
    // –	
    // A)	9
    ...
    // for (let i = 0; i < 3; i++) {
    //   for (let j = 0; j < 3; j++) {
    //     result += i + '' + j + ' ';          // 00 01 02 10 11 12 20 21 22
    //   }
    // }
    // console.log(result);
    // –	
    ...
    //  	for (let i = 1; i <= 2; i++) {
    //   for (let j = 1; j <= 3; j++) {
    //     if (i + j === 4) {       //1+1 1+2 1+3==4 2+1 2+2==4 2+3 
    //       console.log(i, j);     //1,3 2,2 
    //     }
    //   }
    // }
    // –	
    ...
    //   for (let j = 1; j <= 2; j++) {
    //     if (i === 2) continue;   
    //     console.log(i, j);      // 1,1 1,2 3,1 3,2
    //   }
    // }
    // –	
    // A)	1, 1; 1, 2; 2, 1; 2, 2; 3, 1; 3, 2
    ...
    //   for (let j = i; j >= 0; j--) {     //0 ,1 0 , 2 1 0,3 2 1 0
    //     console.log(i, j);  // 0,0  1,1 1,0 2,2 2,1 2,0  3,3 3,2 3,1 3,0
    //   }
    // }
    // –	
    // A)	10
    ...
    //  	let counter = 0;
    // for (let i = 0; i < 4; i++) { // 0 1 2 3
    //   for (let j = 0; j < 2; j++) {  // 0 1, 0 1, 0 1, 0 1
    ...
    //  	for (let i = 1; i <= 2; i++) {  // 1 2 
    //   for (let j = 1; j <= 2; j++) { // 1 , 1 2, 
    //     if (i === j) break;  //1==1 2==2 
    //     console.log(i, j);   // 2,1 
    //   }
    // }
    // –	
    ...
    //  	for (let i = 3; i > 0; i--) {   // 3 2 1
    //   for (let j = 3; j > i; j--) {  // 3>3 3>2 2>2  3>1 2>1 1>1
    //     console.log(i, j);   // 2,3 1,3 1,2
    //   }
    // }
    // –	
    // A)	3, 2; 2, 1; 1, 0
    ...
    //   for (let j = 0; j < 3; j++) {  // 0<3 1<3 2<3 3<3 ,0<3 1<3 2<3 3<3,  
    //     if (i === 2) break;  0===2 1==2 2==2 
    //     console.log(i, j);   // 0,0 0,1 0,2 , 1,0 1,1 1,2 , 2,0 2,1 2,2 
    //   }
    // }
    // –	
    // A)	9
